...
export type GetRefEndpoint = Endpoints['GET /repos/{owner}/{repo}/git/ref/{ref}']

export type CreateRefEndpoint = Endpoints['POST /repos/{owner}/{repo}/git/refs']
export type UpdateRefEndpoint = Endpoints['PATCH /repos/{owner}/{repo}/git/refs/{ref}']
export type DeleteRefEndpoint = Endpoints['DELETE /repos/{owner}/{repo}/git/refs/{ref}']
